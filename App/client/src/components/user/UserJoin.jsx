...
const UserJoin = () => {
    ...
    const JoinFunc = async (e) => {
        ...
        await createdUser.user.updateProfile({
            displayName: youName,
            photoURL: "https://kr.object.ncloudstorage.com/simpleblog/user/slider03.jpg"
        });
        ...
        let body = {
            ...
            uid: createdUser.user.multiFactor.user.uid, // firebase에서 만들어준 아이디(고마워~!)
            photoURL: "https://kr.object.ncloudstorage.com/simpleblog/user/slider03.jpg"
        }
        ...
        <div className='login__wrap'>
            ...
            <form className='login__form'>
                <fieldset>
                    ...
                    <div>
                        <label htmlFor="youName" className="required blind">닉네임</label>
                        <input
                            type="text"
                            id="youName"
                            name="youName"
